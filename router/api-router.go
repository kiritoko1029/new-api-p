...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/:id/coding_plan/usage", controller.GetChannelCodingPlanUsage)
			channelRoute.POST("/:id/coding_plan/refresh", controller.RefreshChannelCodingPlanUsage)
			channelRoute.POST("/coding_plan/refresh", controller.BatchRefreshCodingPlanUsage)
